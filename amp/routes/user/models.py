...
class Property(db.Model, ORM):
    ...
    is_property = db.Column(db.Integer, nullable=False)
    ...
    total_distributions = db.Column(db.Numeric)
    equity_multiple = db.Column(db.Numeric)
    property_irr = db.Column(db.Numeric)
    fund_I_irr = db.Column(db.Numeric)
    fund_II_irr = db.Column(db.Numeric)
    fund_III_irr = db.Column(db.Numeric)
    fund_IV_irr = db.Column(db.Numeric)
    fund_V_irr = db.Column(db.Numeric)
    legacy_fund_irr = db.Column(db.Numeric)
